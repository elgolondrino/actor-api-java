...
public class ActorApiTest extends TestCase {
    ...
    public void testAuth() throws Exception {
        ...
        // Request code
        ResponseRequestAuthCode requestCode = actorApi.rpcSync(new RequestRequestAuthCode(PHONE_NUMBER,
                APP_ID, APP_KEY));
        ...
        // Sign up
        ResponseAuth auth = actorApi.rpcSync(new RequestSignUp(PHONE_NUMBER, requestCode.getSmsHash(),
        ...
        // Find dest user
        ResponseSearchContacts contacts = actorApi.rpcSync(new RequestSearchContacts("+75552212121"));
