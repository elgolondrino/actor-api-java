...
public class UpdateWeakUpdate extends RpcScope {

    public static final int HEADER = 0x1a;
    public static UpdateWeakUpdate fromBytes(byte[] data) throws IOException {
        return Bser.parse(UpdateWeakUpdate.class, data);
    }
    ...
    public UpdateWeakUpdate(long date, int updateId, byte[] update) {
        this.date = date;
        this.updateId = updateId;
        this.update = update;
    }

    public UpdateWeakUpdate() {
