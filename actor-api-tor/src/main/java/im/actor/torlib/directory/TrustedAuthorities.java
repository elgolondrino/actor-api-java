...
public class TrustedAuthorities {
    ...
    private void processArgument(DocumentFieldParser fieldParser, RouterStatus status) {
        ...
        if (Character.isDigit(item.charAt(0))) {
            ...
            DirectoryServer server = new DirectoryServer(status);
    ...
    private void parseAddressPort(DocumentFieldParser parser, String item, RouterStatus status) {
